...
if (nwt){if (ne1x || se1x || sw1x){mnw1=true;nw="£"}}
if (net){if (nw1x || se1x || sw1x){mne1=true;ne="£"}}
if (set){if (nw1x || ne1x || sw1x){mse1=true;se="£"}}
if (swt){if (nw1x || ne1x || se1x){msw1=true;sw="£"}}
...
if (!document.layers){
document.info.disp.style.borderWidth="0px";
document.info.bttn.style.borderWidth="1px";
}